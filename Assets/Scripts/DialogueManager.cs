...
public class DialogueManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        dialogueData.Add(0, new string[] { // 대사와 애니메이션 트리거
            ...
            "그리고 쉬지 않고 움직일수록 체력이 점점 더 빨리 닳아! 계속 무리하면 쓰러질 수 있어.:Sleeping",
            "뛰면 체력이 두 배로 닳으니까 가끔 멈춰서 숨을 고르면서 체력을 관리해야 해!:Sleeping",
            "체력이 부족하다면 곳곳에 열린 빨간 열매를 먹어봐! 잠깐 발도 빨라져. 집에 들어가 침대에서 푹 자면 체력이 가득 찰 거야.:Hooray2",
